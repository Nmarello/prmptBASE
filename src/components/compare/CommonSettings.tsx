...
export default function CommonSettings({ values, onChange, seedLocked, onToggleSeedLock }: CommonSettingsProps) {
  ...
  return (
    ...
    >
      ...
      {expanded && (
        <div className="p-5 grid gap-6" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))' }}>
          ...
          <div style={{ gridColumn: 'span 2' }}>
            ...
            <textarea
              ...
              rows={2}
              className="w-full border rounded-xl px-4 py-3 text-sm pv-placeholder focus:outline-none resize-none"
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                placeholder="Random"
                className="flex-1 border rounded-xl px-4 py-3 text-sm pv-placeholder focus:outline-none"
                style={{ background: 'var(--pv-surface2)', borderColor: 'var(--pv-border)', color: 'var(--pv-text)' }}
              />
              <button
                type="button"
