...
const MODEL_ART: Record<string, { gradient: string; initial: string }> = {
  ...
  'cs-midjourney':      { gradient: 'linear-gradient(145deg,#0a0014,#1a0033,#4a0080)', initial: 'MJ' },
  'cs-ideogram':        { gradient: 'linear-gradient(145deg,#1a0040,#5500cc,#aa44ff)', initial: 'ID' },
  'cs-firefly':         { gradient: 'linear-gradient(145deg,#1a0800,#7a1a00,#e85a00)', initial: 'FF' },
