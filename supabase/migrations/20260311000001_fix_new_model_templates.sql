  ...
  fields = '[
    ...
    },
    {
      ...
      "options": [
        ...
        {"value": "realistic_image",                 "label": "📷 Photo — Standard"},
        {"value": "realistic_image/natural_light",   "label": "📷 Photo — Natural Light"},
        {"value": "realistic_image/studio_portrait", "label": "📷 Photo — Studio Portrait"},
        {"value": "realistic_image/enterprise",      "label": "📷 Photo — Commercial / Enterprise"},
        {"value": "realistic_image/hard_flash",      "label": "📷 Photo — Hard Flash"},
        {"value": "realistic_image/hdr",             "label": "📷 Photo — HDR"},
        {"value": "realistic_image/motion_blur",     "label": "📷 Photo — Motion Blur"},
        {"value": "realistic_image/b_and_w",         "label": "📷 Photo — Black & White"},
        {"value": "realistic_image/urban_drama",     "label": "📷 Photo — Urban Drama"},
        {"value": "realistic_image/retro_snapshot",  "label": "📷 Photo — Retro / Vintage"},
        {"value": "realistic_image/evening_light",   "label": "📷 Photo — Evening Light"},
        {"value": "realistic_image/faded_nostalgia", "label": "📷 Photo — Faded Nostalgia"},

        {"value": "digital_illustration",                      "label": "🎨 Illustration — Standard"},
        {"value": "digital_illustration/hand_drawn",           "label": "🎨 Illustration — Hand Drawn"},
        {"value": "digital_illustration/2d_art_poster",        "label": "🎨 Illustration — 2D Art Poster"},
        {"value": "digital_illustration/3d",                   "label": "🎨 Illustration — 3D"},
        {"value": "digital_illustration/bold_fantasy",         "label": "🎨 Illustration — Bold Fantasy"},
        {"value": "digital_illustration/grain",                "label": "🎨 Illustration — Grainy / Textured"},
        {"value": "digital_illustration/watercolor",           "label": "🎨 Illustration — Watercolor"},
        {"value": "digital_illustration/kawaii",               "label": "🎨 Illustration — Kawaii / Cute"},
        {"value": "digital_illustration/noir",                 "label": "🎨 Illustration — Noir"},
        {"value": "digital_illustration/pixel_art",            "label": "🎨 Illustration — Pixel Art"},
        {"value": "digital_illustration/pop_art",              "label": "🎨 Illustration — Pop Art"},
        {"value": "digital_illustration/psychedelic",          "label": "🎨 Illustration — Psychedelic"},
        {"value": "digital_illustration/80s",                  "label": "🎨 Illustration — 80s Retro"},
        {"value": "digital_illustration/street_art",           "label": "🎨 Illustration — Street Art"},
        {"value": "digital_illustration/expressionism",        "label": "🎨 Illustration — Expressionism"},
        {"value": "digital_illustration/child_book",           "label": "🎨 Illustration — Childrens Book"},
        {"value": "digital_illustration/engraving_color",      "label": "🎨 Illustration — Color Engraving"},
        {"value": "digital_illustration/handmade_3d",          "label": "🎨 Illustration — Handmade 3D"},

        {"value": "vector_illustration",                  "label": "✏️ Vector — Standard"},
        {"value": "vector_illustration/flat_2",           "label": "✏️ Vector — Flat Design"},
        {"value": "vector_illustration/line_art",         "label": "✏️ Vector — Line Art"},
        {"value": "vector_illustration/cartoon",          "label": "✏️ Vector — Cartoon"},
        {"value": "vector_illustration/doodle_line_art",  "label": "✏️ Vector — Doodle / Line Art"},
        {"value": "vector_illustration/bold_stroke",      "label": "✏️ Vector — Bold Stroke"},
        {"value": "vector_illustration/editorial",        "label": "✏️ Vector — Editorial"},
        {"value": "vector_illustration/linocut",          "label": "✏️ Vector — Linocut"},
        {"value": "vector_illustration/kawaii",           "label": "✏️ Vector — Kawaii"},
        {"value": "vector_illustration/engraving",        "label": "✏️ Vector — Engraving"}
      ]
    },
    {
      "id": "aspect_ratio",
